...
<head>
	...
	<link href="http://code.jquery.com/ui/1.10.4/themes/ui-lightness/jquery-ui.css" rel="stylesheet">
        ...
        <link rel="stylesheet" href="assets/framewarp/framewarp.css" />
...
<body>
	...
	<nav class="navbar navbar-inverse" role="navigation">
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="index.jsp">Chinese-StackExchange</a>
		</div>
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<form class="navbar-form navbar-left x-form" role="search">
				<div class="form-group">
					<input type="text" class="x-kw form-control search-inline" placeholder=<%=inputText %>>
				</div>
	...
	<div id="TranslateDialog" title="Translate Helper"></div>
	   ...
	   <script src="assets/js/jquerypp.custom.js"></script>
        <script src="assets/framewarp/framewarp.js"></script> 
	...
	.done(function(data) {
		...
		console.log("success");
		$('#question').html('问题: '+data.inputEnglish+'('+q+')   来源： '+site);
		//alert(inputEnglish);
		itemsArr = data.items;
		...
		if(itemsArr.length!=0){
			for(var i=0; i< itemsArr.length; i++){
				var itemContent = ' <tr> <td class="x-item"> <div class="row"> <div class="tag_line"> <div class="tags"> <b>标签: </b> </div> <div class="score"> 分数: <div id="scoreId"></div> ,&nbsp; <div class="answer_status"></div> ,&nbsp;<a href="" id="linkId">原链接</a>,&nbsp;<a   href="testanswer.jsp?qid='+itemsArr[i].question_id+'&site='+site+'&sort=activity"  class="button2" > 查看回答</a></div> </div> </div> <div class="row"> <table class="inner_table"> <tbody> <tr> <th width="20%">中文标题</th> <th width="20%">英文标题</th> <th width="60%">原文(<a class="bodytrans">查看翻译</a>)</th> </tr> <tr> <td width="20%" class="ctId"></td> <td width="20%" class="etId"></td> <td width="60%" class="btId"></td> </tr> <tr> <td></td> <td></td> <td id="actions">  </td> </tr> </tbody> </table> </div> </td> </tr>';
				//add item frame
			...
			//	$('.table>tbody').append(itemContent);
				...
				if(itemsArr[i].is_answered==true){
					$('.table>tbody>tr:eq('+i+') .answer_status').html('已回答 <span class="glyphicon glyphicon-ok"></span>').css('background-color', 'rgb(9, 211, 9)');
					
				}else{
					$('.table>tbody>tr:eq('+i+') .answer_status').html('未回答 <span class="glyphicon glyphicon-remove"></span>').css('background-color', 'red');
				}
			...
			//	$('.table>tbody').append(" <script src=\"assets/js/jquerypp.custom.js\"><\/script>"   + "<script src=\"assets/framewarp/framewarp.js\"><\/script>");
